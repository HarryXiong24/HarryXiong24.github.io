import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as r,c,a as e,d as t,w as l,b as a,e as o}from"./app-e6d46f41.js";const p="/assets/image-20200308191149927-8fc2743e.png",u={},g=e("h1",{id:"markdown基本语法",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#markdown基本语法","aria-hidden":"true"},"#"),a(" Markdown基本语法")],-1),h={class:"table-of-contents"},_=o(`<hr><h2 id="_1-标题" tabindex="-1"><a class="header-anchor" href="#_1-标题" aria-hidden="true">#</a> 1. 标题</h2><h3 id="_1-1-使用-号标记" tabindex="-1"><a class="header-anchor" href="#_1-1-使用-号标记" aria-hidden="true">#</a> 1.1 使用#号标记</h3><div class="language-text" data-ext="text"><pre class="language-text"><code># 一级标题
## 二级标题
### 三级标题
#### 四级标题
##### 五级标题
...
- 第二项
- 第三项
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>效果如下：</p><ul><li>第一项</li><li>第二项</li><li>第三项</li></ul><ul><li>第一项</li><li>第二项</li><li>第三项</li></ul><ul><li>第一项</li><li>第二项</li><li>第三项</li></ul><h3 id="_3-2-有序列表" tabindex="-1"><a class="header-anchor" href="#_3-2-有序列表" aria-hidden="true">#</a> 3.2 有序列表</h3><p>有序列表使用数字并加上 <strong>.</strong> 号来表示，如：</p><div class="language-text" data-ext="text"><pre class="language-text"><code>1. 第一项
2. 第二项
3. 第三项
...
&gt; &gt; 第一层嵌套
&gt; &gt; &gt; 第二层嵌套
</code></pre></div><blockquote><p>最外层</p><blockquote><p>第一层嵌套</p><blockquote><p>第二层嵌套</p></blockquote></blockquote></blockquote><p>###4.2 区块中使用列表</p><p>区块中使用列表实例如下：</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; 区块中使用列表
&gt; 1. 第一项
&gt; 2. 第二项
&gt; + 第一项
&gt; + 第二项
...
</code></pre></div><p>显示结果如下：</p>`,88),x={href:"https://www.google.com",target:"_blank",rel:"noopener noreferrer"},f=e("p",null,"链接也可以用变量来代替，文档末尾附带变量地址：",-1),v=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`这个链接用 1 作为网址变量 [Google][1]

  [1]: http://www.google.com/
`)])],-1),m={href:"http://www.google.com/",target:"_blank",rel:"noopener noreferrer"},b=o('<hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="footnote1" class="footnote-item"><p>It is really easy! <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p></li></ol></section>',2);function k(w,O){const n=i("router-link"),s=i("ExternalLinkIcon");return r(),c("div",null,[g,e("nav",h,[e("ul",null,[e("li",null,[t(n,{to:"#_1-标题"},{default:l(()=>[a("1. 标题")]),_:1}),e("ul",null,[e("li",null,[t(n,{to:"#_1-1-使用-号标记"},{default:l(()=>[a("1.1 使用#号标记")]),_:1})]),e("li",null,[t(n,{to:"#_1-2-使用-和-号标记一级和二级标题"},{default:l(()=>[a("1.2 使用=和-号标记一级和二级标题")]),_:1})])])]),e("li",null,[t(n,{to:"#_2-段落"},{default:l(()=>[a("2. 段落")]),_:1}),e("ul",null,[e("li",null,[t(n,{to:"#_2-1-字体"},{default:l(()=>[a("2.1 字体")]),_:1})]),e("li",null,[t(n,{to:"#_2-2-分割线"},{default:l(()=>[a("2.2 分割线")]),_:1})]),e("li",null,[t(n,{to:"#_2-3-删除线"},{default:l(()=>[a("2.3 删除线")]),_:1})]),e("li",null,[t(n,{to:"#_2-4-下划线"},{default:l(()=>[a("2.4 下划线")]),_:1})]),e("li",null,[t(n,{to:"#_2-5-注脚"},{default:l(()=>[a("2.5 注脚")]),_:1})])])]),e("li",null,[t(n,{to:"#_3-列表"},{default:l(()=>[a("3. 列表")]),_:1}),e("ul",null,[e("li",null,[t(n,{to:"#_3-1-无序列表"},{default:l(()=>[a("3.1 无序列表")]),_:1})]),e("li",null,[t(n,{to:"#_3-2-有序列表"},{default:l(()=>[a("3.2 有序列表")]),_:1})]),e("li",null,[t(n,{to:"#_3-3-列表嵌套"},{default:l(()=>[a("3.3 列表嵌套")]),_:1})])])]),e("li",null,[t(n,{to:"#_4-区块引用"},{default:l(()=>[a("4. 区块引用")]),_:1}),e("ul",null,[e("li",null,[t(n,{to:"#_4-1-引用"},{default:l(()=>[a("4.1 引用")]),_:1})]),e("li",null,[t(n,{to:"#_4-3-列表中使用区块"},{default:l(()=>[a("4.3 列表中使用区块")]),_:1})])])]),e("li",null,[t(n,{to:"#_5-功能块"},{default:l(()=>[a("5. 功能块")]),_:1}),e("ul",null,[e("li",null,[t(n,{to:"#_5-1-代码块"},{default:l(()=>[a("5.1 代码块")]),_:1})]),e("li",null,[t(n,{to:"#_5-2-公式块"},{default:l(()=>[a("5.2 公式块")]),_:1})])])]),e("li",null,[t(n,{to:"#_6-链接"},{default:l(()=>[a("6. 链接")]),_:1})])])]),_,e("p",null,[a("这是一个链接 "),e("a",x,[a("Google"),t(s)])]),f,v,e("p",null,[a("显示结果如下： 这个链接用 1 作为网址变量 "),e("a",m,[a("Google"),t(s)])]),b])}const $=d(u,[["render",k],["__file","markdown.html.vue"]]);export{$ as default};
