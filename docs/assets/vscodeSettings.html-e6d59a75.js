import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as e,a as n,b as s,d as l,w as c,e as u}from"./app-dbf2ee88.js";const r={},i=n("h1",{id:"vscode-推荐配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vscode-推荐配置","aria-hidden":"true"},"#"),s(" VSCode 推荐配置")],-1),k=u(`<p>将下面内容拷贝至 setting.json 以更改 VSCode 设置</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
