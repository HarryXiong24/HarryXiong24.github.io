import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as n,e as t}from"./app-79d257de.js";const e={},o=t(`<h1 id="纵向查看" tabindex="-1"><a class="header-anchor" href="#纵向查看" aria-hidden="true">#</a> 纵向查看</h1><p>我们已经成功地添加并提交了一个 readme.txt 文件，继续修改 readme.txt 文件，改成如下内容:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code>Git is a distributed version control system.
