import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r,o,c as u,a as e,d as n,w as l,b as s,e as d}from"./app-f601f3f8.js";const c={},v=e("h1",{id:"express",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#express","aria-hidden":"true"},"#"),s(" Express")],-1),p={class:"table-of-contents"},m=d(`<h2 id="_1-引入express" tabindex="-1"><a class="header-anchor" href="#_1-引入express" aria-hidden="true">#</a> 1.引入express</h2><div class="language-text" data-ext="text"><pre class="language-text"><code>npm install express --save
