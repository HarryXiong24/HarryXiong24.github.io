import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as p}from"./app-a63d3fdb.js";const t={},o=p(`<h2 id="module" tabindex="-1"><a class="header-anchor" href="#module" aria-hidden="true">#</a> Module</h2><p>模块功能主要由两个命令构成</p><ul><li><p><strong>export命令用于规定模块的对外接口</strong></p></li><li><p><strong>import命令用于输入其他模块提供的功能</strong></p></li></ul><p><strong>注意</strong>:</p><ul><li><p>ES6的模块自动采用严格模式,不管有没有在模块头部加上&quot;use strict&quot;</p></li><li><p>export与import命令可以出现在模块的任何位置,只要处于模块顶层作用域就可以,如果处于块级作用域内等就会报错</p></li></ul><h3 id="_17-1-export" tabindex="-1"><a class="header-anchor" href="#_17-1-export" aria-hidden="true">#</a> 17.1 export</h3><p><strong>一个模块就是一个独立的文件,该文件内部的所有变量外部都无法获取。如果希望外部能够读取模块内部的某个变量,就必须使用export命令输出该变量</strong></p><p><strong>具体操作:</strong></p><ul><li><p><strong>export实际上时导出一个接口,让外界能通过该接口访问内部的数据</strong>,所以export会将要导出的变量装在一个对象中,通过传递出这个对象来使用导出文件内部的变量,所以在导出的时候有格式要求</p></li><li><ul><li><strong>导出变量</strong></li></ul></li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//profile.js</span>
