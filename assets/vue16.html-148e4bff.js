import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as e,e as a}from"./app-b9757f99.js";const t={},i=a(`<h2 id="对象数组更新" tabindex="-1"><a class="header-anchor" href="#对象数组更新" aria-hidden="true">#</a> 对象数组更新</h2><h3 id="_16-1-vue-set" tabindex="-1"><a class="header-anchor" href="#_16-1-vue-set" aria-hidden="true">#</a> 16.1 Vue.set</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>Vue<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span> target<span class="token punctuation">,</span> propertyName<span class="token operator">/</span>index<span class="token punctuation">,</span> value <span class="token punctuation">)</span>
