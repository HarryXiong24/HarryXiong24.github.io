import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-ea5ec429.js";const p={},t=e(`<h2 id="逻辑语句" tabindex="-1"><a class="header-anchor" href="#逻辑语句" aria-hidden="true">#</a> 逻辑语句</h2><h3 id="_5-1-if语句" tabindex="-1"><a class="header-anchor" href="#_5-1-if语句" aria-hidden="true">#</a> 5.1 if语句</h3><p>if语句对一个属性或者表达式进行判断,里面的数或表达式最后会转换为布尔值，如果为真才执行执行if语句里面的代码</p><h4 id="_5-1-1-if" tabindex="-1"><a class="header-anchor" href="#_5-1-1-if" aria-hidden="true">#</a> 5.1.1 if</h4><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">if</span><span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
