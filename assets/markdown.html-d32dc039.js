import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as r,c,a,d as t,w as l,b as e,e as o}from"./app-932220eb.js";const p="/assets/image-20200308191149927-8fc2743e.png",u={},h=a("h1",{id:"markdown-基本语法",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#markdown-基本语法","aria-hidden":"true"},"#"),e(" Markdown 基本语法")],-1),g={class:"table-of-contents"},_=o(`<hr><h2 id="_1-标题" tabindex="-1"><a class="header-anchor" href="#_1-标题" aria-hidden="true">#</a> 1. 标题</h2><h3 id="_1-1-使用-号标记" tabindex="-1"><a class="header-anchor" href="#_1-1-使用-号标记" aria-hidden="true">#</a> 1.1 使用#号标记</h3><div class="language-text" data-ext="text"><pre class="language-text"><code># 一级标题
## 二级标题
### 三级标题
#### 四级标题
##### 五级标题
