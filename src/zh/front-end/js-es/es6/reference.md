...
- Bradley Meck, [ES6 Module Interoperability](https://github.com/nodejs/node-eps/blob/master/002-es6-modules.html): 介绍 Node 如何处理 ES6 语法加载 CommonJS 模块
...
- Node EPS, [ES Module Interoperability](https://github.com/nodejs/node-eps/blob/master/002-es-modules.html): Node 对 ES6 模块的处理规格
